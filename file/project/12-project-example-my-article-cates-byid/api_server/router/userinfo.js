...
// - - - 导入需要的验证规则对象，命名 update_userinfo_schema, update_password_schema, update_avatar_schema
...
router.post('/update/avatar', expressJoi.joiValidate(update_avatar_schema), userinfo_handler.updateAvatar)
